...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var timer = __webpack_require__(/*! ./parts/timer.js */ "./src/parts/timer.js"),
      ...
      decoration = __webpack_require__(/*! ./parts/decoration.js */ "./src/parts/decoration.js"),
      glazing = __webpack_require__(/*! ./parts/glazing.js */ "./src/parts/glazing.js"),
      images = __webpack_require__(/*! ./parts/images.js */ "./src/parts/images.js"),
      modal = __webpack_require__(/*! ./parts/modal.js */ "./src/parts/modal.js"),
      modalForm = __webpack_require__(/*! ./parts/modalForm.js */ "./src/parts/modalForm.js");
...
function calc() {
  var btnsCalc = document.querySelectorAll('.popup_calc_btn'),
  ...
  function calc() {
    balconIconsImg.forEach(function (item, i) {
      balconIconsImg[i].addEventListener('click', function () {
        for (var j = 0; j < balconIconsImg.length; j++) {
    ...
    function clearFormCalc() {
      for (var j = 0; j < formCalc.length; j++) {
  ...
  function clearInput() {
    for (var j = 0; j < input.length; j++) {
      input[j].value = '';
      checkbox[1].checked = false;
      checkbox[0].checked = false; // очистка всех инпутов
    }
  }
  ...
  forms.forEach(function (item, i) {
    forms[i].addEventListener('submit', function (event) {
      ...
      if (i == 8) {
        ...
        }).then(clearInput).then(closeForm);
      }
    });
  });
}
  ...
  sliderItems.forEach(function (item, i) {
    sliderItems[i].addEventListener('click', function () {
      for (var j = 0; j < sliderItems.length; j++) {
        var a = sliderItems[j].querySelector('div');
        a.classList.remove('after_click');
        decorContent[0].children[j].style.display = 'none';
      }

      var b = sliderItems[i].querySelector('div');
...
function glazing() {
  var glazing = document.querySelector('.glazing_slider'),
  ...
  elemGlaz.forEach(function (item, i) {
    elemGlaz[i].addEventListener('click', function () {
      for (var j = 0; j < elemGlaz.length; j++) {
...
function images() {
  ...
  function modalImg(i) {
    ...
    img.src = "img/our_works/big_img/".concat(i + 1, ".png");
    img.style.position = 'absolute';
    img.style.top = '10%';
    img.style.left = '50%';
    img.style.maxHeight = "650px";
    img.style.transform = 'translateX(-50%)';
    document.body.style.overflow = 'hidden'; // div.styleText = ??  не работает почему то ???
  }
...
function modal() {
  ...
  function openModalPopup() {
    var popup = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : modalPopup;
...
function modalForm() {
  ...
  function clearInput() {
    for (var j = 0; j < formInput.length; j++) {
      formInput[j].value = ''; // очистка всех инпутов
    }
  }
